...
class FilterTypeRes extends Component {
  constructor(props) {
    super(props);
  ...
  onclick() {
    ...
    //console.log(deact1);
    this.props.resourceTypeStore.filterTypeR(act1, deact1);
  }
  render() {
    return (
      <table>
...
export default inject("resourceTypeStore")(observer(FilterTypeRes));
